        ...
        if ($categories = $this->_getCategories(PLX_ROOT . $this->plxAdmin->aConf['categories'])) {
            ...
            <document>
                ...
                foreach ($categories as $cat_id => $cat) {
                    ?>
                    <categorie number="<?= $cat_id ?>" tri="<?= $cat['tri'] ?>" bypage="<?= $cat['bypage'] ?>"
                               menu="<?= $cat['menu'] ?>" url="<?= $cat['url'] ?>" template="<?= $cat['template'] ?>">
            ...
            if (!plxUtils::write(XML_HEADER . ob_get_clean(), PLX_ROOT . $this->plxAdmin->aConf['categories'])) {
                ?>
                <p class="error"><?= L_UPDATE_ERR_CATEGORIES_MIGRATION ?> (<?= $this->plxAdmin->aConf['categories'] ?>
                    )</p>
                <?php
                return false;
            }
            ...
            <document>
                ...
                foreach ($statics as $static_id => $static) {
                    ...
                    <statique number="<?= $static_id ?>" active="<?= $static['active'] ?>" menu="<?= $static['menu'] ?>"
                              url="<?= $static['url'] ?>" template="<?= $static['template'] ?>">
