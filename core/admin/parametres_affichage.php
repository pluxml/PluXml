...
?>
    ...
    <form method="post" id="form_display" class="first-level">
        ...
        <div class="adminheader">
            ...
            <div>
                <div>
                    <input class="inbl btn--primary" type="submit" name="config-display" role="button"
                           value="<?= L_SAVE ?>"/>
                </div>
            </div>
        </div>
        ...
        <fieldset>
            ...
            <div>
                ...
                <input type="number" name="bypage_tags" value="<?= $plxAdmin->aConf['bypage_tags'] ?>"
                       id="id_bypage_tags"/>
            </div>
            <div>
                <label for="id_bypage_archives"><?= L_CONFIG_VIEW_BYPAGE_ARCHIVES ?></label>
                <input type="number" name="bypage_archives" value="<?= $plxAdmin->aConf['bypage_archives'] ?>"
                       id="id_bypage_archives"/>
            </div>
            <div>
                <label for="id_bypage_admin"><?= L_CONFIG_VIEW_BYPAGE_ADMIN ?></label>
                <input type="number" name="bypage_admin" value="<?= $plxAdmin->aConf['bypage_admin'] ?>"
                       id="id_bypage_admin"/>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" name="bypage_admin_coms" value="<?= $plxAdmin->aConf['bypage_admin_coms'] ?>"
                       id="id_bypage_admin_coms"/>
            </div>
            <div>
                <label for="id_display_empty_cat"><?= L_CONFIG_VIEW_DISPLAY_EMPTY_CAT ?></label>
                <input type="checkbox" name="display_empty_cat" value="1"
                       class="switch" <?= !empty($plxAdmin->aConf['display_empty_cat']) ? 'checked' : '' ?>
                       id="id_display_empty_cat"/>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" name="miniatures_l" value="<?= $plxAdmin->aConf['miniatures_l'] ?>"/><span
                        class="surface">X</span>
                <input type="number" name="miniatures_h" value="<?= $plxAdmin->aConf['miniatures_h'] ?>"/>
            </div>
            <div>
                <label for="id_thumbs"><?= L_MEDIAS_THUMBS ?></label>
                <input type="checkbox" name="thumbs" value="1"
                       class="switch" <?= !empty($plxAdmin->aConf['thumbs']) ? 'checked' : '' ?>
                       id="id_display_empty_cat"/>
            </div>
            <?php plxUtils::printThumbnail($plxAdmin->aConf); ?>
            <div>
                <label for="id_bypage_feed"><?= L_CONFIG_VIEW_BYPAGE_FEEDS ?></label>
                <input type="number" name="bypage_feed" value="<?= $plxAdmin->aConf['bypage_feed'] ?>"
                       id="id_bypage_feed"/>
            </div>
            <div>
                ...
                <input type="checkbox" name="feed_chapo" value="1"
                       class="switch" <?= !empty($plxAdmin->aConf['feed_chapo']) ? 'checked' : '' ?>
                       id="id_feed_chapo"/>
            </div>
            <div class="large">
