...
<div class="adminheader">
	...
	<ul>
		...
		<li <?= ($_SESSION['sel_get']=='mod')?'class="selected" ':'' ?>><a href="articles.php?sel=mod&amp;page=1"><?= L_ALL_AWAITING_MODERATION ?></a><?php if ($nbArticlesWaiting > 0) : ?>&nbsp;<span class="tag--warning"><?= $nbArticlesWaiting ?></span><?php endif; ?></li>
	</ul>
</div>
