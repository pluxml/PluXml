...
$file_frontend = PLX_ROOT.PLX_CONFIG_PATH.$plxAdmin->aConf['racine_plugins'].basename($plugin).'.site.css';
# chargement du fichier css du plugin pour le backend
$file_backend = PLX_ROOT.PLX_CONFIG_PATH.$plxAdmin->aConf['racine_plugins'].basename($plugin).'.admin.css';
