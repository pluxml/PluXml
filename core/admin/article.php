	...
	<div class="grid">
		...
		<div class="col sml-12 med-5 lrg-4">
			...
			<fieldset>
                ...
                <div class="basic-form">
                    <label for="id_tags">
                        <?php echo L_ARTICLE_TAGS_FIELD ?>&nbsp;:&nbsp;<a title="<?php echo L_ARTICLE_TAGS_FIELD_TITLE ?>"><img class="help" src="theme/images/help.png" alt="Help"></a>
                    </label>
                    <div class="inline-form">
				...
				<div class="basic-form">
					<label for="id_url">
						<?php echo L_ARTICLE_URL_FIELD ?>&nbsp;:&nbsp;<a title="<?php echo L_ARTICLE_URL_FIELD_TITLE ?>"><img class="help" src="theme/images/help.png" alt="Help"></a>
					</label>
