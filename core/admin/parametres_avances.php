...
<?php eval($plxAdmin->plxPlugins->callHook('AdminSettingsAdvancedTop')) # Hook Plugins ?>
	...
	<fieldset>
		...
		<div class="basic-form">
			...
			<a class="help" title="<?php echo L_CONFIG_ADVANCED_GZIP_HELP ?>"><img src="theme/images/help.gif" alt="Help"></a>
		</div>
		<div class="basic-form">
		...
		<div class="basic-form">
			...
			<a class="help" title="<?php echo L_CONFIG_ADVANCED_KEY_HELP ?>"><img src="theme/images/help.gif" alt="Help"></a>
		</div>
	</fieldset>
	<fieldset class="config">
		<div class="basic-form">
			...
			<a class="help" title="<?php echo L_HELP_SLASH_END ?>"><img src="theme/images/help.gif" alt="Help"></a>
		</div>
		<div class="basic-form">
