...
$LANG = array (
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId (vereist door Azure)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Bestelling voor een token',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Provider voor token',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'De volgende gegevens worden verkregen door een app in te stellen in de ontwikkelaarsconsole van uw provider.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Inloggegevens voor Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Bestelling voor token geweigerd',
		...
		'L_CONFIG_INFOS_NB_ARTS'	=> 'Aantal artikelen :',
		'L_CONFIG_INFOS_NB_CATS' => 'Aantal categorie?n :',
		'L_CONFIG_INFOS_NB_STATICS' => 'Aantal statische paginas :',
		'L_CONFIG_INFOS_NB_USERS' => 'Aantal gebruikers :',
		'L_CONFIG_INFOS_NEXT_ID_ART' => 'Volgende id van artikel :',
		...
		'L_PLUXML_UPDATE_AVAILABLE' => 'Een nieuwe PluXml-versie is beschikbaar! Je kunt downloaden van',
		...
		'L_WARNING_INSTALLATION_FOLDER' => 'De installatiemap is nog steeds te vinden in de root van uw site.<br />Om veiligheidsredenen wordt sterk aangeraden deze te verwijderen.</a>.',
