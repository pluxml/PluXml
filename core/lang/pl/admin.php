...
const L_RENAME_FILE_ERR = 'Błąd podczas przetwarzania pliku';
...
const L_ARTICLE_DELETE_SUCCESSFUL = 'Post został pomyślnie usunięty';
...
const L_PLXMEDIAS_DELETE_FILE_ERR = 'Wystąpił błąd podczas usuwania pliku';
...
const L_DEFAULT_NEW_ARTICLE_TITLE = 'Nowy post';
...
const L_CATEGORY_HOME_PAGE = 'Strona główna';
...
const L_ARTICLE_TEMPLATE_FIELD = 'Szablon';
...
const L_ARTICLE_NEW_COMMENT = 'Napisz komentarz';
...
const L_ARTICLE_OFFLINE_BUTTON = 'Deaktywuj';
const L_ARTICLE_UPDATE_BUTTON = 'Zapisz';
const L_CATEGORY_ADD_BUTTON = 'Dodaj';
...
const L_ARTICLE_TITLE_HTMLTAG = 'Zawartość tagu "tytułu" (opcjonalnie)';
const L_ARTICLE_CHAPO_HIDE = 'ukryj';
const L_ARTICLE_CHAPO_DISPLAY = 'pokaż';
const L_ARTICLE_ID = 'Identyfikator';
const L_PINNED_ARTICLE = 'Przypięty artykuł';
...
const L_CAT_LIST_ARTS = 'L. artykułów';
const L_CAT_LIST_ACTIVE = 'Aktywna';
const L_CAT_LIST_NAME = 'Nazwa kategorii';
const L_CAT_LIST_URL = 'URL';
const L_CAT_LIST_SORT = 'Sortowanie artykułów';
const L_CAT_LIST_BYPAGE = 'Nr. artykułu/strony';
const L_CAT_LIST_ORDER = 'Kolejność';
...
const L_EDITCAT_TEMPLATE = 'Szablon';
const L_EDITCAT_BACK_TO_PAGE = 'Przejdż do listy kategorii';
const L_EDITCAT_UPDATE = 'Zapisz zmiany';
const L_EDITCAT_TITLE_HTMLTAG = 'Zawartość tagu "tytułu" (opcjonalnie)';
...
const L_COMMENT_DELETE_SUCCESSFUL = 'Komentarz został pomyślnie usunięty';
...
const L_COMMENT_SAVE_BUTTON = 'Napisz';
const L_ARTICLE_COMMENTS_LIST = 'Komentarze do tego artukułu';
const L_COMMENT_ANSWER_TITLE = 'Odpowiedź na ten komentarz';
const L_COMMENT_ANSWER = 'Odpowiedź';

// comments.php

const L_COMMENTS_ARTICLE_SCOPE = 'Artykuł';
...
const L_COMMENTS_LIST_ACTION = 'Działanie';
const L_COMMENT_EDIT = 'Edytuj';
const L_COMMENT_EDIT_TITLE = 'Edytuj ten komentarz';
const L_COMMENT_DELETE = 'Usuń';
...
const L_COMMENT_SET_OFFLINE = 'Zdeaktywuj komentarz';
...
const L_ARTICLES_ALL_AUTHORS = 'Wszyscy autorzy...';
const L_ALL = 'Wszystkie';
const L_ALL_PUBLISHED = 'Opublikowane';
const L_ALL_DRAFTS = 'Projekty';
const L_ALL_AWAITING_MODERATION = 'Oczekiwanie na zatwierdzenie';
const L_ARTICLES_FILTER_BUTTON = 'Filtr';
const L_CATEGORIES_TABLE = 'Kategorie';
...
const L_MEDIAS_DELETE_FOLDER = 'Usunąć';
...
const L_MEDIAS_ADD = 'Dodać';
const L_MEDIAS_ALIGNMENT = 'Wyrównanie';
const L_MEDIAS_ALIGN_NONE = 'Nie';
...
const L_CONFIG_VIEW_FIELD = 'Opcje wyświetlania';
const L_CONFIG_VIEW_SKIN_SELECT = 'Wybierz szablon';
const L_CONFIG_VIEW_FILES_EDIT_TITLE = 'Edycja plików z szablonu';
...
const L_CONFIG_VIEW_SORT_COMS = 'Sortowanie komentarzy';
const L_CONFIG_VIEW_BYPAGE_ADMIN_COMS = 'Liczba komentarzy wyświetlanych na stronę w administracji';
const L_CONFIG_VIEW_IMAGES = 'Rozmiar obrazu (szerokość x wysokość)';
const L_CONFIG_VIEW_THUMBS = 'Rozmiar miniatury (szerokość x wysokość)';
const L_CONFIG_VIEW_HOMESTATIC = 'Użyj strony statycznej jako strony głównej';
const L_CONFIG_VIEW_HOMESTATIC_ACTIVE = 'Uwaga ta strona jest nieaktywna';
const L_CONFIG_VIEW_PLUXML_RESSOURCES = 'Pobierz inne motywy na %s.';
const L_CONFIG_VIEW_BYPAGE_FEEDS = 'Liczba artykułów/komentarzy opublikowanych w kanałach RSS';
const L_CONFIG_VIEW_FEEDS_HEADLINE = 'Wyświetlaj tylko nagłówki w kanale artykułów RSS';
const L_CONFIG_VIEW_FEEDS_HEADLINE_HELP = 'Pole nagłówka jest puste, zamiast tego wyświetlana jest treść';
const L_CONFIG_VIEW_FEEDS_FOOTER = 'Podpis używany na końcu każdego artykułu w kanale RSS';
const L_CONFIG_VIEW_UPDATE = 'Zapisz ustawienia wyświetlania';
const L_CONFIG_VIEW_DISPLAY_EMPTY_CAT = 'Wyświetl kategorie bez artykułu';
const L_CONFIG_HOMETEMPLATE = 'Szablon strony głównej';
...
const L_CONFIG_ADVANCED_USERSFOLDERS = 'Użyj innego folderu multimediów niż użytkownicy';
const L_HELP_SLASH_END = 'Nie zapomnij o ukośniku na końcu';
const L_CONFIG_ADVANCED_MEDIAS_FOLDER = 'Lokalizacja multimediów (folder)';
const L_CONFIG_ADVANCED_ARTS_FOLDER = 'Lokalizacja elementów (folder)';
...
const L_CONFIG_ADVANCED_UPDATE = 'Zmodyfikuj konfigurację zaawansowaną';
const L_CONFIG_CUSTOM_CSSADMIN_PATH = 'Lokalizacja i nazwa osobistego pliku css do dostosowania interfejsu administratora (opcjonalnie)';
...
const L_CONFIG_BASE_CONFIG_TITLE = 'Podstawowa konfiguracja';
const L_CONFIG_BASE_SITE_TITLE = 'Tytuł strony';
const L_CONFIG_BASE_SITE_SLOGAN = 'Opis / slogan strony';
const L_CONFIG_BASE_URL_HELP = 'Nie zapomnij o ukośniku na końcu';
const L_CONFIG_BASE_DEFAULT_LANG = 'Domyślny język strony';
const L_CONFIG_BASE_TIMEZONE = 'Strefa czasowa';
const L_CONFIG_BASE_ALLOW_COMMENTS = 'Pokaż komentarze';
...
const L_CONFIG_INFOS_DESCRIPTION = 'Informacje o Twojej instalacji PluXml mogą być przydatne do jej naprawy w razie potrzeby.';
const L_CONFIG_INFOS_NB_ARTS =  'Liczba artykułów :';
const L_CONFIG_INFOS_NB_CATS =  'Liczba kategorii :';
const L_CONFIG_INFOS_NB_STATICS =  'Liczba stron statycznych :';
const L_CONFIG_INFOS_NB_USERS =  'Liczba użytkowników :';
const L_CONFIG_INFOS_NEXT_ID_ART =  'Inastępny identyfikator artykułu :';
const L_CONFIG_INFOS_WRITER = 'Liczba użytkowników w sesji:';
const L_PLUXML_CHECK_VERSION = 'Sprawdzanie numeru wersji na oficjalnej stronie #PLUXML#';
const L_PLUXML_UPDATE_UNAVAILABLE = 'Nie można sprawdzić dostępności aktualizacji, dopóki opcja „allow_url_fopen” jest wyłączona w tym systemie';
const L_PLUXML_UPDATE_ERR = 'Sprawdzanie aktualizacji nie powiodło się z nieznanego powodu';
const L_PLUXML_UPTODATE = 'Używasz najnowszej wersji PluXml';
const L_PLUXML_UPDATE_AVAILABLE = 'Dostępna jest nowa wersja PluXml!';
...
const L_CONFIG_USERS_TITLE = 'Zarządzaj użytkownikami';
const L_CONFIG_USER = 'Użytkownik';
const L_CONFIG_USERS_ID = 'Identyfikator użytkownika';
const L_CONFIG_USERS_ACTIVE = 'Aktywny';
const L_CONFIG_USERS_ACTION = 'Akcja';
const L_CONFIG_USERS_NEW = 'Nowy użytkownik';
const L_CONFIG_USERS_UPDATE = 'Zmodyfikuj listę użytkowników';
const L_ERR_LOGIN_ALREADY_EXISTS = 'Identyfikator logowania jest już używany';
...
const L_PLUGIN_NO_CONFIG = 'Nieskonfigurowana wtyczka';
const L_PLUGINS_CSS = 'Kod CSS';
const L_PLUGINS_CSS_TITLE = 'Edytuj kod css wtyczki';
const L_CONTENT_FIELD_FRONTEND = 'Witryna z zawartością plików CSS';
const L_CONTENT_FIELD_BACKEND = 'Administrator treści plików CSS';

// parametres_plugins.php

const L_PLUGINS_TITLE = 'Zarządzaj wtyczkami';
const L_PLUGINS_VERSION = 'Wersja';
const L_PLUGINS_AUTHOR = 'Autor';
const L_PLUGINS_ACTIVATE = 'Włączyć';
const L_PLUGINS_DEACTIVATE = 'Wyłączyć';
const L_PLUGINS_DELETE = 'Usunąć';
const L_PLUGINS_DELETE_ERROR = 'Podczas usuwania wystąpił błąd';
const L_PLUGINS_ENABLED_ERROR = 'Wtyczka %s włączona.';
const L_DELETE_FILE_ERROR = 'Błąd podczas usuwania pliku %s';
const L_PLUGINS_DELETE_SUCCESSFUL = 'Pomyślne usunięcie';
const L_PLUGINS_CONFIG = 'Konfiguracja';
const L_PLUGINS_CONFIG_TITLE = 'Konfiguracja wtyczki';
const L_PLUGINS_HELP = 'Pomoc';
const L_PLUGINS_HELP_TITLE = 'Patrz Korzystanie z wtyczki';
const L_PLUGINS_REQUIREMENTS = 'Wymagania';
const L_PLUGINS_REQUIREMENTS_HELP = 'Dostępne i aktywne wtyczki do aktywacji tej';
const L_PLUGINS_REQUIREMENTS_NONE = 'Nic';
...
const L_PROFIL_MAIL = 'Adres e-mail';
const L_PROFIL_ADMIN_LANG = 'Język używany w administracji';
...
const L_STATIC_TITLE_HTMLTAG = 'Zawartość tagu "tytułu" (opcjonalnie)';
...
const L_STATICS_TITLE = 'Tytuł';
const L_STATICS_URL = 'URL';
const L_STATICS_ACTIVE = 'Aktywna';
const L_STATICS_ORDER = 'Kolejność';
const L_STATICS_MENU = 'Menu';
const L_STATICS_ACTION = 'Akcja';
const L_STATICS_TEMPLATE_FIELD = 'Szablon';
...
const L_PROFIL_SUBSCRIBER = 'Abonent';
const L_ADMIN = 'Administracja';
const L_LOGIN = 'Login';
const L_ADMIN_LOGOUT = 'Wyloguj';
const L_ADMIN_LOGOUT_TITLE = 'Opuść panel administracyjny';
const L_BACK_TO_SITE = 'Strona główna';
const L_BACK_TO_SITE_TITLE = 'Przejdż do strony głównej';
...
const L_MENU_NEW_ARTICLES = 'Napisz nowy artykuł';
const L_MENU_NEW_ARTICLES_TITLE = 'Nowy artykuł';
...
const L_MENU_COMMENTS = 'Komentarze';
...
const L_MENU_CATEGORIES = 'Kategorie';
...
const L_WARNING_INSTALLATION_FILE = 'Plik install.php znajduje się w katalogu głównym PluXml. <br />Ze względów bezpieczeństwa zaleca się, aby go <a class="lnkdelete" href="%s">usunąć</a>.';

// user.php

const L_USER_UNKNOWN = 'Nieznany użytkownik';
const L_USER_LANG = 'Język używany w administracji';
const L_USER_MAIL = 'Adres e-mail';
const L_USER_INFOS = 'Informacja';
...
const L_MENU_CONFIG_BASE = 'Podstawowa konfiguracja';
...
const L_MENU_CONFIG_ADVANCED = 'Zaawansowana konfiguracja';
const L_MENU_CONFIG_INFOS_TITLE = 'Informacja na temat PluXml';
const L_MENU_CONFIG_INFOS = 'Informacja';
