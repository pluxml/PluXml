...
$LANG = array (
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId (wymagane przez Azure)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Zamawianie tokena',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Dostawca tokena',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'Poniższe szczegóły są uzyskiwane poprzez skonfigurowanie aplikacji w konsoli deweloperskiej dostawcy.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Poświadczenia dla Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Zamówienie tokena odrzucone',
		...
		'L_CONFIG_INFOS_TITLE' => 'Informacje powiązane z PluXml',
		'L_CONFIG_INFOS_DESCRIPTION' => 'Te informacje dotyczą działania PluXml i mogą być przydatne przy rozwiązywaniu problemów.',
		'L_CONFIG_INFOS_NB_ARTS'	=> 'Liczba artykułów :',
		'L_CONFIG_INFOS_NB_CATS' => 'Liczba kategorii :',
		'L_CONFIG_INFOS_NB_STATICS' => 'Liczba stron statycznych :',
		'L_CONFIG_INFOS_NB_USERS' => 'Liczba użytkowników :',
		'L_CONFIG_INFOS_NEXT_ID_ART' => 'Inastępny identyfikator artykułu :',
		'L_CONFIG_INFOS_WRITER' => 'Nazwa bieżącego redaktora :',
		'L_PLUXML_CHECK_VERSION' => 'VSprawdź numer wersji PluXml na oficjalnej stronie: PluXml.org',
		'L_PLUXML_UPDATE_UNAVAILABLE' => 'Nie można sprawdzić dostępności aktualizacji, gdy opcja „allow_url_fopen” jest wyłączona w tym systemie',
		'L_PLUXML_UPDATE_ERR' => 'Sprawdzanie aktualizacji nie powiodło się z nieznanego powodu.',
		'L_PLUXML_UPTODATE' => 'Używasz najnowszej wersji PluXml',
		'L_PLUXML_UPDATE_AVAILABLE' => 'Nowa wersja PluXml została wydana! Możesz ją pobrać ze strony',
