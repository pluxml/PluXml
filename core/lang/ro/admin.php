...
$LANG = array (
		...
		'L_ID' => '#',
		'L_MENU' => 'Meniu',
		'L_PHP_ERROR_LOG' => 'Funcție PHP interzisă (vezi jurnalul)',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId ( solicitat de Azure )',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Jeton',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Generați un jeton',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Furnizor pentru jeton',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'Următoarele detalii sunt obținute prin configurarea unei aplicații în consola pentru dezvoltatori a furnizorului dvs.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Acreditări pentru Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Comandă pentru un jeton',
		...
		'L_CONFIG_INFOS_NB_ARTS'	=> 'Numărul de articole :',
		'L_CONFIG_INFOS_NB_CATS' => 'Numărul de categorii :',
		'L_CONFIG_INFOS_NB_STATICS' => 'Numărul de pagini statice :',
		'L_CONFIG_INFOS_NB_USERS' => 'Numărul de utilizatori :',
		'L_CONFIG_INFOS_NEXT_ID_ART' => 'Următorul ID al articolului :',
		...
		'L_WARNING_INSTALLATION_FOLDER' => 'Folderul de instalare poate fi găsit în continuare la rădăcina site-ului dvs.<br />Din motive de securitate, este recomandat să îl <a class="lnkdelete" href="%s">ștergeți</a>.',
