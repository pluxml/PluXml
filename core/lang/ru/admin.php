...
$LANG = array (
		...
		'L_WARNING_INSTALLATION_FILE' => 'Внимание! Файл install.php все еще находится в корневой папке PluXml.<br />Из соображений безопасности настоятельно рекомендуем <a id="lnkdelete">удалить</a> его.',
