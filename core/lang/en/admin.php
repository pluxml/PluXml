...
$LANG = array (
		...
		'L_PHP_ERROR_LOG' => 'PHP function prohibited (see log)',
		...
		'L_NO_ENTRY' => 'No entry',
		'L_ERR_INVALID_USERNAME' => 'Please enter a username',
		'L_ERR_INVALID_PASSWORD' => 'Please enter a password',
		'L_ERR_INVALID_PASSWORD_CONFIRMATION' => 'Wrong or missing password',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantID (only relevant for Azure)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Order for a token',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Provider for getting a token',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'The following details are obtained by setting up an app in your provider\'s developer console.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Credentials for Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Order of token is denied',
		...
		'L_CONFIG_INFOS_NB_ARTS'	=> 'Count of articles :',
		'L_CONFIG_INFOS_NB_CATS' => 'Count of categories :',
		'L_CONFIG_INFOS_NB_STATICS' => 'Count of static pages :',
		'L_CONFIG_INFOS_NB_USERS' => 'Count of users :',
		'L_CONFIG_INFOS_NEXT_ID_ART' => 'Next Id of article :',
		'L_CONFIG_INFOS_WRITER' => 'Count of users in session :',
		...
		'L_MAIL_TEST_SUBJECT' => 'Test email sent from your website %s',
