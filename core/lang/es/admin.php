...
$LANG = array (
		...
		'L_ID' => '#',
		'L_MENU' => 'Menú',
		'L_PHP_ERROR_LOG' => 'Función PHP prohibida (ver registro)',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId (requerido por Azure)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Pedido de token denegado',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Proveedor de token',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'Los siguientes detalles se obtienen configurando una aplicación en la consola para desarrolladores de su proveedor.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Credenciales para Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Pedido de token denegado',
		...
		'L_CONFIG_INFOS_NB_ARTS'	=> 'recuento de artículos:',
		'L_CONFIG_INFOS_NB_CATS' => 'Cantidad de categorías:',
		'L_CONFIG_INFOS_NB_STATICS' => 'Cantidad de páginas estáticas:',
		'L_CONFIG_INFOS_NB_USERS' => 'Número de usuarios:',
		'L_CONFIG_INFOS_NEXT_ID_ART' => 'Siguiente ID del artículo:',
		...
		'L_PLUXML_UPDATE_AVAILABLE' => '¡Una nueva versión de PluXml está disponible! Puede descargarla desde',
		...
		'L_WARNING_INSTALLATION_FOLDER' => 'La carpeta de instalación aún se puede encontrar en la raíz de su sitio.<br />Por razones de seguridad, se recomienda encarecidamente <a class="lnkdelete" href="%s">eliminar</a>',
