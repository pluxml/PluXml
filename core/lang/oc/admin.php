...
const L_RENAME_FILE_ERR = 'Error pendent lo tractament del fichièr';
...
const L_PLXMEDIAS_DELETE_FILE_ERR = 'Error pendent la supression del fichièr';
...
const L_CATEGORY_HOME_PAGE = 'Pagina d\'acuèlh';
...
const L_ARTICLE_TEMPLATE_FIELD = 'Modèl';
...
const L_ARTICLE_NEW_COMMENT = 'Escriure un comentari';
...
const L_CAT_LIST_SORT = 'Tria dels articles';
const L_CAT_LIST_BYPAGE = 'Nb art/pagina';
const L_CAT_LIST_ORDER = 'Òrdre';
...
const L_COMMENT_EMAIL_FIELD = 'Corrièl';
...
const L_COMMENTS_LIST_ACTION = 'Accion';
...
const L_COMMENT_SET_OFFLINE = 'Metre fòra linha';
...
const L_ALL_AWAITING_MODERATION = 'En espèra de validacion';
...
const L_ARTICLE_LIST_TITLE = 'Títol';
const L_ARTICLE_LIST_CATEGORIES = 'Categoria';
const L_ARTICLE_LIST_NBCOMS = 'Nb coms';
const L_ARTICLE_LIST_AUTHOR = 'Autor';
const L_ARTICLE_LIST_ACTION = 'Accion';
const L_CATEGORY_HOME = 'Pagina d\'acuèlh';
const L_CATEGORY_DRAFT = 'Borrolhon';
...
const L_MEDIAS_DELETE_FOLDER = 'Suprimir';
...
const L_MEDIAS_ADD = 'Ajustar';
const L_MEDIAS_ALIGNMENT = 'Alinhament';
const L_MEDIAS_ALIGN_NONE = 'Cap';
...
const L_CONFIG_VIEW_FIELD = 'Opcions d\'afichatge';
const L_CONFIG_VIEW_SKIN_SELECT = 'Causida del tèma';
const L_CONFIG_VIEW_FILES_EDIT_TITLE = 'Editar los fichièrs del tèma';
...
const L_CONFIG_ADVANCED_404 ='Tornar dirigir en 404 las requèstas desconegudas';
const L_CONFIG_ADVANCED_200 ='Ajustèr de requèsta(s) coneguda(s).';
const L_CONFIG_ADVANCED_G200_HELP ='shens espacis, shens caractéres especiaus, shens accents e separer dab | . Aqueras requèstas ne seràn pas tornar dirigir en 404. èx: pluxml|ostau ';
...
const L_CONFIG_BASE_CONFIG_TITLE = 'Configuracion de basa';
const L_CONFIG_BASE_SITE_TITLE = 'Títol del site';
const L_CONFIG_BASE_SITE_SLOGAN = 'Sos-títol/descripcion del site';
const L_CONFIG_BASE_URL_HELP = 'Oblidar pas lo slash a la fin';
const L_CONFIG_BASE_DEFAULT_LANG = 'Lenga per defaut del site';
const L_CONFIG_BASE_TIMEZONE = 'Fus orari';
const L_CONFIG_BASE_ALLOW_COMMENTS = 'Autorizar los comentaris';
...
const L_PLUXML_CHECK_VERSION = 'Verificacion del numerò de version de PluXml sul site oficial PluXml.org';
...
const L_CONFIG_USERS_ID = 'Numèro d\'utilizaire';
const L_CONFIG_USERS_ACTIVE = 'Actiu';
const L_CONFIG_USERS_ACTION = 'Accion';
...
const L_PLUGINS_REQUIREMENTS_NONE = 'Cap';
...
const L_PROFIL_MAIL = 'Adreça de corrièl';
const L_PROFIL_ADMIN_LANG = 'Lenga utilizada dins l\'administracion';
...
const L_STATIC_TITLE_HTMLTAG = 'Contengut balisa títol (opcion)';
...
const L_STATICS_ID = 'Identificant';
const L_STATICS_GROUP = 'Grop';
const L_STATICS_TITLE = 'Títol';
const L_STATICS_URL = 'Url';
const L_STATICS_ACTIVE = 'Activa';
const L_STATICS_ORDER = 'Òrdre';
const L_STATICS_MENU = 'Menú';
const L_STATICS_ACTION = 'Accion';
...
const L_BACK_TO_SITE = 'Tornar al site';
const L_BACK_TO_SITE_TITLE = 'Tornar a la pagina d\'acuèlh del site';
...
const L_MENU_NEW_ARTICLES = 'Novèl article';
const L_MENU_NEW_ARTICLES_TITLE = 'Novèl article';
...
const L_MENU_COMMENTS = 'Comentaris';
...
const L_USER_INFOS = 'Informacions';
...
const L_MENU_CONFIG_BASE = 'Configuracion de basa';
...
const L_MENU_CONFIG_ADVANCED = 'Configuracion avançada';
const L_MENU_CONFIG_INFOS_TITLE = 'Aver d\'informacions sus vòstre PluXml';
const L_MENU_CONFIG_INFOS = 'Informacions';
