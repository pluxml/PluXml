...
$LANG = array (
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId ( requerit per Azure )',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Geton',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Generar un geton',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Comandar un geton',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'Los detalhs seguents son obtenguts en configurant una aplicacion dins la consola de desvolopaire de vòstre provesidor.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Credencials per Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Comanda de geton refusada',
		...
		'L_WARNING_INSTALLATION_FOLDER' => 'lo dorsièr d\'installacion es present a la raiç de vòstre sit.<br />Per de rasons de seguretat, es fòrtament conselhat d\'o <a class="lnkdelete" href="%s">suprimir</a>.',
