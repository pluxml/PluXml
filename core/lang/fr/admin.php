...
$LANG = array (
		...
		'L_PHP_ERROR_LOG' => 'fonction PHP interdite (voir log)',
		...
		'L_ERR_INVALID_PASSWORD_CONFIRMATION' => 'Mauvaise confirmation ou mot de passe vide',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId (requis par Azure)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Jeton (token)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Demander un jeton (token)',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Fournisseur de jeton',
		...
		'L_MAIL_TEST_SUBJECT' => 'E-mail de test envoyé depuis votre site %s',
