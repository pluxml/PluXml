...
const L_CONFIG_ADVANCED_404 ='Rediriger en 404 les requêtes inconnues';
const L_CONFIG_ADVANCED_200 ='Ajout de requête(s) connue(s).';
const L_CONFIG_ADVANCED_G200_HELP ='sans espaces, sans caractéres spéciaux, sans accents et  separer avec | . Ces requêtes ne seront pas rediriger en 404. ex: pluxml|maison ';
