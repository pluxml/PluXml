...
$LANG = array (
		...
		'L_ID' => '#',
		'L_MENU' => 'Menu',
		'L_PHP_ERROR_LOG' => 'Funzione PHP proibita (vedi registro)',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId (richiesto da Azure)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Genera un token',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Provider per token',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'I seguenti dettagli si ottengono impostando un\'app nella console per sviluppatori del provider.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Credenziali per Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Ordine per token negato',
		'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP' => 'Ho bisogno di aiuto : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentazione di PluXml</a>&nbsp;🇫🇷',
		...
		'L_CONFIG_INFOS_NB_ARTS'	=> 'Conteggio degli articoli :',
		'L_CONFIG_INFOS_NB_CATS' => 'Numero di categorie',
		'L_CONFIG_INFOS_NB_STATICS' => 'Numero di pagine statiche :',
		'L_CONFIG_INFOS_NB_USERS' => 'Conteggio degli utenti :',
		'L_CONFIG_INFOS_NEXT_ID_ART' => 'ID successivo dell\'articolo :',
		...
		'L_WARNING_INSTALLATION_FOLDER' => 'La cartella di installazione è ancora presente nella directory principale del tuo sito.<br />Per motivi di sicurezza, è fortemente consigliata la <a class="lnkdelete" href="%s">cancellazione</a>.',
