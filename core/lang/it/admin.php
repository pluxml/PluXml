...
'L_CONFIG_CUSTOM_CSSADMIN_PATH'								=> 'Personalizzato posizione del file css dell\'area amministrazione (optional)',
...
'L_WARNING_INSTALLATION_FILE'								=> '<p class="alert red">Il file install.php è presente nella radice di PluXml.<br />Per motivi di sicurezza, è fortemente consigliata la cancellazione.</p>',
