...
const L_CONFIRM_DELETE = 'Confermare l\'eliminazione ?';
...
const L_RENAME_FILE_ERR = 'Errore durante l\'elaborazione del file';
...
const L_ARTICLE_DELETE_SUCCESSFUL = 'Articolo cancellato con successo';
...
const L_ARTICLE_TITLE = 'Titolo';
const L_ARTICLE_LIST_AUTHORS = 'Autore';
...
const L_ARTICLE_TEMPLATE_FIELD = 'Modello';
...
const L_ARTICLE_NEW_COMMENT = 'Scrivi un commento';
...
const L_ARTICLE_MODERATE_BUTTON = 'Sottoporre per l\'approvazione';
const L_ARTICLE_OFFLINE_BUTTON = 'Disabilita';
const L_ARTICLE_UPDATE_BUTTON = 'Registra';
const L_CATEGORY_ADD_BUTTON = 'Aggiungi';
const L_ARTICLE_META_DESCRIPTION = 'Contenuto del meta tag "description" (facoltativo)';
const L_ARTICLE_META_KEYWORDS = 'Contenuto del meta tag "keywords" (facoltativo)';
const L_ARTICLE_TITLE_HTMLTAG = 'Titolo contenuto tag (opzionale)';
...
const L_EDITCAT_TEMPLATE = 'Modello';
...
const L_COMMENT_AUTHOR_FIELD = 'Autore';
...
const L_COMMENT_EMAIL_FIELD = 'Email';
...
const L_COMMENT_ADMIN_ARTICLE_FIELD = 'Il tuo commento';
...
const L_COMMENT_SAVE_BUTTON = 'Salva';
...
const L_COMMENTS_LIST_ACTION = 'Azione';
...
const L_ARTICLE_LIST_TITLE = 'Titolo';
const L_ARTICLE_LIST_CATEGORIES = 'Categoria';
const L_ARTICLE_LIST_NBCOMS = 'No commenti';
const L_ARTICLE_LIST_AUTHOR = 'Autore';
const L_ARTICLE_LIST_ACTION = 'Azione';
const L_CATEGORY_HOME = 'Homepage';
const L_CATEGORY_DRAFT = 'Bozza';
const L_ARTICLE_VIEW_TITLE = 'Visualizza questo articolo sul sito';
const L_ARTICLE_EDIT = 'Modifica';
...
const L_TAGS_SAVE_SUCCESS = '%d articoli taggati';
const L_TAGS_SAVE_ERROR = 'Il salvataggio dei tag nel file tags.xml non riesce';
...
const L_MEDIAS_EXTENSION = 'Estensione';
const L_MEDIAS_ADD = 'Aggiungi';
const L_MEDIAS_ALIGNMENT = 'Allineamento';
const L_MEDIAS_ALIGN_NONE = 'No';
...
const L_CONFIG_VIEW_FILES_EDIT = 'Modifica i file del tema';
const L_CONFIG_VIEW_SORT = 'Ordinamento degli articoli';
const L_CONFIG_VIEW_BYPAGE = 'Numero di articoli visualizzati per pagina';
const L_CONFIG_VIEW_BY_HOMEPAGE = 'Numero di articoli sulla home page';
...
const L_CONFIG_ADVANCED_USERSFOLDERS = 'Usa cartelle multimediali separate da questo profilo';
const L_HELP_SLASH_END = 'Non dimenticare la slash alla fine';
...
const L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL = 'Indirizzo email';
const L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP = 'Ho bisogno di aiuto : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentazione di PluXml</a>&nbsp;(fr)';
...
const L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP = 'PluXml consente di generare token solo per il servizio <a href="https://cloud.google.com">GMAIL (Google)</a>.<br>Hai bisogno di aiuto per generare il nome utente e la chiave segreta : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentazione di PluXml</a>&nbsp;(fr).';
const L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL_HELP = 'Indirizzo utilizzato sul servizio OAUTH2 (esempio : pluxml@gmail.com)';
...
const L_GET_OAUTH_TOKEN_CLIENTID_HELP = 'ID cliente sul servizio OAUTH2 (esempio : 664335625964-uha1vop20qPluXml81ubjkkgfabbbj6d.apps.googleusercontent.com)';
const L_GET_OAUTH_TOKEN_SECRETKEY = 'Chiave segreta del cliente';
const L_GET_OAUTH_TOKEN_SECRETKEY_HELP = 'La chiave client sul servizio OAUTH2 (esempio : PrsvKp6aprKpoP8snnCoC8-x)';
const L_GET_OAUTH_TOKEN_TENANTID = 'TenantId (richiesto da Azure)';
const L_GET_OAUTH_TOKEN_TOKEN = 'Token';
const L_GET_OAUTH_TOKEN_CREDENTIALS = 'Credenziali di Google';
const L_GET_OAUTH_TOKEN_DENIED = 'Ordine per un token negato';
...
const L_CONFIG_BASE_URL_HELP = 'Non dimenticare la slash alla fine';
const L_CONFIG_BASE_DEFAULT_LANG = 'Lingua predefinita del sito';
const L_CONFIG_BASE_TIMEZONE = 'Fuso orario';
const L_CONFIG_BASE_ALLOW_COMMENTS = 'Autorizza i commenti';
...
const L_CONFIG_INFOS_NB_ARTS =  'Conteggio degli articoli :';
const L_CONFIG_INFOS_NB_CATS =  'Numero di categorie';
const L_CONFIG_INFOS_NB_STATICS =  'Numero di pagine statiche :';
const L_CONFIG_INFOS_NB_USERS =  'Conteggio degli utenti :';
const L_CONFIG_INFOS_NEXT_ID_ART =  'ID successivo dell\'articolo :';
const L_CONFIG_INFOS_WRITER = 'Nome dell\'utente collegato :';
const L_PLUXML_CHECK_VERSION = 'Verifica della versione di PluXml sul sito ufficiale #PLUXML#';
...
const L_CONFIG_USERS_ACTION = 'Azione';
...
const L_PLUGINS_REQUIREMENTS_NONE = 'Nessuno';
const L_PLUGINS_ALPHA_SORT = 'Ordine alfabetico plugins';
const L_PLUGINS_LOADING_SORT = 'Caricamento in corso per';
const L_PLUGINS_ACTION = 'Azione';
const L_PLUGINS_APPLY_BUTTON = 'Cambia l\'ordine dei plugin';
...
const L_PROFIL_MAIL = 'Indirizzo email';
const L_PROFIL_ADMIN_LANG = 'Lingua usata nel pannello di amministrazione';
const L_PROFIL_INFOS = 'Informazioni';
...
const L_STATICS_TITLE = 'Titolo';
const L_STATICS_URL = 'Url';
const L_STATICS_ACTIVE = 'Attiva';
const L_STATICS_ORDER = 'Ordine';
const L_STATICS_MENU = 'Menu';
const L_STATICS_ACTION = 'Azione';
const L_STATICS_TEMPLATE_FIELD = 'Modello';
...
const L_BACK_TO_SITE_TITLE = 'Ritorna al sito';
...
const L_MENU_NEW_ARTICLES = 'Nuovo articolo';
const L_MENU_NEW_ARTICLES_TITLE = 'Nuovo articolo';
...
const L_USER_INFOS = 'Informazioni';
...
const L_MENU_CONFIG_ADVANCED = 'Configurazione avanzata';
