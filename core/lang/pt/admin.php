...
$LANG = array (
		...
		'L_PHP_ERROR_LOG' => 'Função PHP proibida (ver log)',
		...
		'L_ERR_INVALID_PASSWORD_CONFIRMATION' => 'A confirmação da senha está errada',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TENANTID' => 'TenantId (exigido pelo Azure)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_SECRETKEY' => 'Chave secreta do cliente',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
		'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Pedido de token',
		'L_GET_OAUTH_TOKEN_PROVIDER' => 'Fornecedor para token',
		'L_GET_OAUTH_TOKEN_DETAILS' => 'Os detalhes seguintes são obtidos configurando uma aplicação na consola do programador do seu fornecedor.',
		'L_GET_OAUTH_TOKEN_CREDENTIALS' => 'Credenciais para o Google',
		'L_GET_OAUTH_TOKEN_DENIED' => 'Pedido de token negado',
		...
		'L_CONFIG_INFOS_NB_ARTS'	=> 'Contagem de artigos :',
		'L_CONFIG_INFOS_NB_CATS' => 'Contagem de categorias :',
		'L_CONFIG_INFOS_NB_STATICS' => 'Contagem de páginas státicas :',
		'L_CONFIG_INFOS_NB_USERS' => 'contagem de utilizadores :',
		'L_CONFIG_INFOS_NEXT_ID_ART' => 'Próximo id do artigo :',
